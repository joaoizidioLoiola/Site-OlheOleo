...
const FooterNavigation = () => {
    return (
        <footer className="bg-txt w-full h-1/6 flex flex-col justify-around fixed bottom-0 text-white p-2">
            <div className="flex felx-col md:flex-row items-center justify-end md:justify-between">
                <div className="flex justify-center w-full md:w-auto mb-2 md:mb-0 hidden md:block">
